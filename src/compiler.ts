...
async function fetchBreezeScriptCode(src: string) {
    try {
...
function tokenize(code: string, delimiter: string[]) {
...
function tokenizeExpression(expression: string[], delimiters: string[]) {
    let output: string[][] = [];
    let temp = '';
...
function compileExpression(expression: string[], srcLang: any) {
...
function compileLine(line: string[] | undefined, srcLang: any) {
